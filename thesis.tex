...
\subsection{The Thermal Hall Effect}
...
the experimental signature of different kinds of surface states\cite{Wang14}:
...
fermions in the topological superconductors with supersymmetry~\cite{Grover14}.
...
measurements have been made in ferromagnets\cite{Onose10}, frustrated quantum
magnets\cite{Hirschberger15}, and cuprate superconductors\cite{Cvetkovic15}, but
...
point\cite{Rowley14}. Materials similar to SrTiO$_3$, such as Barium Titanate
...
thick.} \centering
\includegraphics[width=\columnwidth,natwidth=1413,natheight=1060]{thermometers.jpg}\label{thermo_pic}
\end{figure}
...
\includegraphics[width=\columnwidth]{cvt.eps}\label{cal_curve}
\end{figure}
...
to change in temperature of 0.1 mK. Other measurements~\cite{Hirschberger15}
...
\centering \includegraphics[width=\columnwidth]{cvb.eps}\label{b_test}
\end{figure}
...
this temperature range\cite{Heine98,Goodrich98}. We are not sure what the nature
...
diameter phosphor bronze leads, with a thermal conductivity of 69.9 $\mathrm{W/m
  ...
  $\mathrm{W/m\cdot K}$ at room temperature~\cite{Ekin07}.  Given the dimensions
  ...
  temperature~\cite{White58}, while that of phosphor bronze goes
  down~\cite{Ekin07}, the quality will only improve at the measurement
  temperatures.
...
\includegraphics[width=\columnwidth]{rawCurve.eps} \end{figure}
...
and the de Haas van Alphen effect\cite{deHaas30}, and perhaps more directly
related to the field of thermal transport measurements, the Seebeck
effect\cite{Seebeck22}. It has a unique electronic structure, being a semimetal
with Dirac-like dispersion\cite{Lui95, Li08}, strong spin-orbit
coupling\cite{Yafet63}, and pronounced diamagnetism\cite{Shoenberg36}. More
recently, it has been studied\cite{Emoto16} for its ability to convert spin
...
Kobayashi \textit{et al.}\cite{Kobayashi12} down to 75 K and magnetic fields up
...
\includegraphics[width=\columnwidth]{kappaxy.eps} \end{figure}

Similar to what was measured before\cite{Kobayashi12}, the thermal Hall
...
even more fraught\cite{Heine98, Goodrich98}. One promising line of study
involved isotopically substituting $^{18}$O into the strontium titanate wafers,
which has been shown\cite{Rowley14} to drive them closer to the ferroelectric
