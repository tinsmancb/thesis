...
One potentially interesting question to consider is how this thermal conductivity signal might be connected to another phenomena observed in SCBO at temperatures below 1 K: The formation of spin superlattices.

\begin{figure}
	\centering
	\caption[Spin Superlattices in SCBO]{Spin Superlattices in SCBO.}
	\includegraphics[width=0.6\columnwidth]{figures/SCBO_superlattice.pdf}
	\includegraphics[width=\columnwidth]{figures/SCBO_plateaus.pdf}
\end{figure}
